...
def play_game(board, n):
    ...
    for i in range(1, n+1):
        ...
        for cell in alive_cells:
            ...
            neighbours = [cell_neighbour.coordinate for cell_neighbour in Coordinate(cell[0], cell[1]).get_neighbours()]
        ...
        for cell in alive_cells:
            ...
            for neighbour in neighbours:
                if (neighbour not in alive_cells):
                    ...
                    neighbour_neighbours = [cell_neighbour.coordinate for cell_neighbour in Coordinate(neighbour[0], neighbour[1]).get_neighbours()]
                    alive_neighbours = 0
