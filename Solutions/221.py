...
# DRIVER CODE
print(get_sevenish_num(1))  # 1 = 7 ^ 0
print(get_sevenish_num(2))  # 7 = 7 ^ 1
print(get_sevenish_num(3))  # 8 = 7 ^ 0 + 7 ^ 1
print(get_sevenish_num(4))  # 49 = 7 ^ 2
print(get_sevenish_num(5))  # 50 = 7 ^ 0 + 7 ^ 2
print(get_sevenish_num(6))  # 57 = 7 ^ 0 + 7 ^ 1 + 7 ^ 2
